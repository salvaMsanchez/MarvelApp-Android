...
class LocalDataSource @Inject constructor(
    ...
    override fun getCharacter(characterId: Long): CharacterLocal = dao.getCharacter(characterId)
    ...
    override fun getFavoriteCharactersWithFlow(): Flow<List<CharacterLocal>> =
        dao.getFavoriteCharactersWithFlow()
    ...
    override fun deleteCharactersMinusFirstTwenty() = dao.deleteCharactersMinusFirstTwenty()
}